...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift) * r.Weight / MInKm * float64(r.Duration) / float64(time.Hour)) * MinInHours
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return CaloriesWeightMultiplier*w.Weight + (math.Pow(w.meanSpeed()*KmHInMsec, 2) / float64(w.Height/CmInM) * CaloriesSpeedHeightMultiplier * w.Duration.Minutes() * MinInHours)
